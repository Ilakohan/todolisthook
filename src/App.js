    ...
    <div className="App">
      ...
      <div className="container">
        ...
        <div className="input-container">
          <input type="text" value={userInput} onChange={(e) => setUseInput(e.target.value)} ref={ref} />
          <button onClick={addTodoHandler}>Add</button>
        </div>
        {todos.length === 0 && <h2 style={{ color: "#fff", fontWeight: "bold" }}>Start adding Todos...</h2>}
        <div className="todos-container-parent">
          {todos.map((todo, index) => (
            <div key={todo.id} className="todo-container-child">
